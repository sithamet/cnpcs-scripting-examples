...
*/
    ...
    addSkillCheck(
        ...
        28 /* Уровень сложности */,
        199 /* ID диалога, в опциях которого доступны варианты провала и успеха */,
        210 /* ID диалога успеха */,
        211 /* ID диалога провала */,
    ...
    addSkillCheck(
        rollDice(20) /* Кубик */,
        "Проворство" /* Навык для проверки */,
        28 /* Уровень сложности */,
        212 /* ID диалога, в опциях которого доступны варианты провала и успеха */,
        225 /* ID диалога успеха */,
        224 /* ID диалога провала */,
        "переброс", /* уник, переброс, разблок */
        0 /* рост сложности при провале, 0 для отключения штрафа, отрицательные для облегчения */,
        /* Ниже — сообщение, что добавляется при провале к хабу.
        "" чтобы не добавлять */
    ...
    addSkillCheck(
        ...
        28 /* Уровень сложности */,
        214 /* ID диалога, в опциях которого доступны варианты провала и успеха */,
        229 /* ID диалога успеха */,
        228 /* ID диалога провала */,
        "переброс", /* уник, переброс, разблок */
        0 /* рост сложности при провале, 0 для отключения штрафа, отрицательные для облегчения */,
        /* Ниже — сообщение, что добавляется при провале к хабу.
        "" чтобы не добавлять */
    ...
    addSkillCheck(
        rollDice(20) /* Кубик */,
        "Координация" /* Навык для проверки */,
        28 /* Уровень сложности */,
        215 /* ID диалога, в опциях которого доступны варианты провала и успеха */,
        231 /* ID диалога успеха */,
        230 /* ID диалога провала */,
        "переброс", /* уник, переброс, разблок */
        0 /* рост сложности при провале, 0 для отключения штрафа, отрицательные для облегчения */,
        /* Ниже — сообщение, что добавляется при провале к хабу.
        "" чтобы не добавлять */
